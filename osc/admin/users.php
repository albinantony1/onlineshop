       ...
       <div class="content" style="margin-top: 0px; margin-right: 0px; margin-bottom: 5px; margin-left: 0px; padding-top: 5px; padding-right: 5px; padding-bottom: 5px; padding-left: 5px; background-color: rgb(243, 243, 243); border-top-width: 1px; border-top-style: solid; border-top-color: rgb(221, 221, 221); border-left-width: 1px; border-left-style: solid; border-left-color: rgb(221, 221, 221); border-right-width: 1px; border-right-style: solid; border-right-color: rgb(221, 221, 221); border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: rgb(139, 138, 138); ">
         ...
         <div>
           <table width="730" border="1">
             <tr>
               <th width="71" height="56" scope="col">Username</th>
               <th width="98" scope="col">Name</th>
               <th width="159" scope="col">Address</th>
               <th width="55" scope="col">State</th>
               <th width="85" scope="col">Phone</th>
               <th width="120" scope="col">Email</th>
               <th width="43" scope="col">Edit</th>
               <th width="47" scope="col">Delete</th>
             </tr>
             <?php do { ?>
                 <?php if ($totalRows_rsusers > 0) { // Show if recordset not empty ?>
  <tr>
    <td height="70"><?php echo $row_rsusers['username']; ?></td>
    <td><p><?php echo $row_rsusers['first_name']; ?></p>
      <p><?php echo $row_rsusers['last_name']; ?></p></td>
    <td><p><?php echo $row_rsusers['address_line1']; ?></p>
      <p><?php echo $row_rsusers['address_line2']; ?></p>
      <p><?php echo $row_rsusers['city']; ?></p>
      <p><?php echo $row_rsusers['pincode']; ?></p></td>
    <td><?php echo $row_rsusers['state']; ?></td>
    <td><?php echo $row_rsusers['phone']; ?></td>
    <td><?php echo $row_rsusers['email']; ?></td>
    <td>&nbsp;&nbsp;<a href="edit_user.php?id=<?php echo $row_rsusers['username']; ?>">Edit</a></td>
    <td>&nbsp;<a href="delete_user.php?id=<?php echo $row_rsusers['username']; ?>">Delete</a></td>
  </tr>
  <?php } // Show if recordset not empty ?>
<?php } while ($row_rsusers = mysqli_fetch_assoc($rsusers)); ?>
           </table>
           <p>&nbsp;</p>
         </div>
...
<div class="footer">
  ...
  <div class="right_footer">
    <div align="center"><a href="index.html">home</a> <a href="about us.html">about</a> <a href="details.html">sitemap</a><a href="contact.html">contact us</a> </div>
  </div>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>

    ...
    <form action="" method="post">
	 ...
	 ?>
       <table width="519" border="0">
         <tr>
           <td width="122" height="44" align="center">User Name</td>
           <td width="130" align="center">First Name</td>
           <td width="125" align="center">Last Name</td>
           <td width="124" align="center"><strong>Delete</strong></td>
         </tr>
         <?php
		...
		?>
         <tr>
           <td align="center"><p><?php echo $r[0];?></p></td>
           <td align="center"><p><?php echo $r[2];?></p></td>
           <td align="center"><p><?php echo $r[3];?></p></td>

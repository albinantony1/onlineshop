...
<div id="main_container">
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">ADD NEW CATEGORY</div>
    <div id="new_books">
      <form id="form1" name="form1" method="post" action="add_category_process.php"> 
        <p>&nbsp;</p>
        <h4>
          <label></label>
        </h4>
        <div id="Layer2">
          <table width="311" height="127" border="0" align="left">
            <tr>
              <td width="160" height="60"><h3><span class="style6">Category Name</span></h3></td>
              <td width="144"><input name="txtcat" type="text" id="txtcat" maxlength="20" /></td>
            </tr>
            <tr>

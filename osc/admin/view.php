    ...
    <form action="" method="post">
	 ...
	 ?>
       <table width="474" border="0">
         <tr>
           <td width="104" align="center"height="44"><strong>Product Id</strong></td>
           <td width="135" align="center"><strong>Product Name</strong></td>
		...
		?>
         <tr>
           ...
           <td align="center"><p><?php echo $r[2];?></p></td>
           <td align="center"><a href="edit.php?id=<?php echo $r[0];?>">Edit</a></td>
           <td align="center"><a href="delete.php?id=<?php echo $r[0];?>">Delete</a></td>
         </tr>
         <?php
		 }
		 ?>

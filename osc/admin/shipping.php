...
<div id="main_container">
   ...
   <div id="main_content"> 
            ...
            <div class="left_menu_corner"></div>
                    <ul class="menu">
                      ...
                      <li><a href="admin.php" class="nav6">Admin</a></li>
                         <li class="divider"></li>
                         <li><a href="../index.php" class="nav6">Log Out</a>               
                    </ul>
    ...
    Navigation: <a href="index.php">Home</a> &lt; <span class="current"><a href="shipping.php">Shipping</a></span>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
              	...
              	<div class="contact_form">
              	  <p>&nbsp;</p>
              	  <p>We ship your items within 48 working hours. We use premium courier like DTDC, Bluedart and Aramex. You can track your items at </p>
              	  <ul>
              	    <li><a href="www.dtdc.in">www.dtdc.in</a></li>
              	    <li><a href="www.bluedart.com">www.bluedart.com</a></li>
              	    <li><a href="www.aramex.com">www.aramex.com</a></li>
           	      </ul>
<p>&nbsp;</p>
              	  <p>&nbsp;</p>
